...
namespace TmyFlower.Common
{
    public class DbContext
    {
        public static SqlSugarClient db = new SqlSugarClient(new ConnectionConfig()
        {
            ConnectionString = "Server=localhost;Database=TmyFlowerDb;Uid=sa;Pwd=123456;Trusted_Connection=True;Encrypt=false;",//连接符字串
        ...
        public static void InitDataBase()
        {
            ...
            //创建表
            string nspace = "TmyFlower.Model.Entitys";
            Type[] ass = Assembly.LoadFrom("bin/Debug/net6.0/TmyFlower.Model.dll").GetTypes().Where(p => p.Namespace == nspace).ToArray();
